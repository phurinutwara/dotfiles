...
CONFIG_DIR="$XDG_CONFIG_HOME/ags.v1"
...
terminalscheme="$XDG_CONFIG_HOME/ags.v1/scripts/templates/terminal/scheme-base.json"
...
if [ ! -f $colormodefile ]; then
    ...
    if [ "$materialscheme" = "monochrome" ]; then
        terminalscheme="$XDG_CONFIG_HOME/ags.v1/scripts/templates/terminal/scheme-monochrome.json"
    fi
fi
